    ...
    <div className="min-h-screen w-full flex bg-background">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <form onSubmit={submit} className="w-full max-w-sm animate-entrance">
          ...
          <p className="text-sm text-muted-foreground mb-8">Entre com sua conta para continuar.</p>

          {error && (
            <div className="flex items-center gap-2 text-xs text-rose-600 bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800 rounded-md px-3 py-2.5 mb-5">
