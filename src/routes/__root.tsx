...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Sinal — Painel WhatsApp para restaurantes" },
      {
        name: "description",
        content:
          "Conecte o WhatsApp do seu restaurante e gerencie pedidos, conversas, cardápio e financeiro em um painel único.",
      },
    ],
    links: [
